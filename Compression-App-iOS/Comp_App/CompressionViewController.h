...
//Gain 1
@property (weak, nonatomic) IBOutlet UISlider *GainB1Slider;
@property (weak, nonatomic) IBOutlet UILabel *GainB1Label;

//Gain 2
@property (weak, nonatomic) IBOutlet UISlider *GainB2Slider;
@property (weak, nonatomic) IBOutlet UILabel *GainB2Label;

//Gain 3
@property (weak, nonatomic) IBOutlet UISlider *GainB3Slider;
@property (weak, nonatomic) IBOutlet UILabel *GainB3Label;

//Gain 4
@property (weak, nonatomic) IBOutlet UISlider *GainB4Slider;
@property (weak, nonatomic) IBOutlet UILabel *GainB4Label;

//Gain 5
@property (weak, nonatomic) IBOutlet UISlider *GainB5Slider;
@property (weak, nonatomic) IBOutlet UILabel *GainB5Label;
