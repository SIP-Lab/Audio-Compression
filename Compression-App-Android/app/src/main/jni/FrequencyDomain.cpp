...
//#include "../../../../../../../../../../Desktop/Developer/SuperpoweredSDK/Superpowered/AndroidIO/SuperpoweredAndroidAudioIO.h"
...
CompressionVars *vadNoiseRedCom;
Settings *settings;
...
static bool audioProcessing(
        ...
        int numberOfSamples,             // The number of frames received and/or requested.
    ...
    perform_Compression(vadNoiseRedCom, left, output, settings);
...
extern "C" JNIEXPORT void Java_com_superpowered_IntegratedApp_MainActivity_FrequencyDomain(JNIEnv *javaEnvironment,
    ...
    vadNoiseRedCom = init_Compression(settings);
    //timer = newTimer();
...
void Java_com_superpowered_IntegratedApp_MainActivity_StopAudio(JNIEnv* javaEnvironment, jobject __unused obj, jstring fileIn, jstring fileOut){
    ...
    if(inputBufferFloat != NULL){
        ...
        destroy_Compression(&vadNoiseRedCom);
...
extern "C" JNIEXPORT void
        Java_com_superpowered_IntegratedApp_MainActivity_UpdateSettingsFromJSON(JNIEnv* __unused env,
                                                                                jobject __unused instance,
                                                                                jboolean compressionSwitch,
                                                                                jboolean noiseReductionSwitch){

    if (settings != NULL ) {
        if(compressionSwitch){settings->compressionOutputType = 1;}else{settings->compressionOutputType = 0;};
        if(noiseReductionSwitch ){settings->noiseReductionOutputType = 1;}else{settings->noiseReductionOutputType = 0;}
    }
}


extern "C" JNIEXPORT float
Java_com_superpowered_IntegratedApp_MainActivity_getSPLCalibration(JNIEnv* __unused env,
                                                                             jobject __unused instance) {
...
extern "C" JNIEXPORT void
Java_com_superpowered_IntegratedApp_MainActivity_updateSettingsSPLCalibration(JNIEnv* __unused env,
                                                                                        jobject __unused instance,
                                                                                        jfloat calibration) {
...
/*extern "C" JNIEXPORT void
Java_com_superpowered_IntegratedApp_settingsFromJsonFile_UpdateSettingsFromJSON(JNIEnv* __unused env,
                                                                                jobject __unused instance,
                                                                                jint compressionSwitch,
                                                                                jint noiseReductionSwitch,
                                                                                jint AFCswitch,
                                                                                jint CompNumParams){

    if (settings != NULL ) {
    settings->compressionOutputType = compressionSwitch;
    settings->noiseReductionOutputType = noiseReductionSwitch;
    }
}*/
